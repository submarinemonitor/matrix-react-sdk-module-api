...
export declare type AppTitleContext = AppTitleBase | AppTitleInRoom;
...
export declare abstract class BrandingExtensionsBase implements ProvideBrandingExtensions {
    getAppTitle(context: AppTitleContext): string | null;
    getFaviconSrc(content?: number | string, opts?: GetFaviconParameters): Promise<string | null>;
}
export {};
